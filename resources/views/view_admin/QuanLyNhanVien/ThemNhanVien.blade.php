...
<head>
	...
	<link rel="stylesheet" href="{{asset('css/css_admin/css_NhanVien/CSS_Them.css')}}">
...
<body>
	...
	<div class="content">
			...
			<div class="col-md-10">
				...
				@endif
				<form class="form-horizontal" action="{{route('them_nhanvien')}}" method="POST">
					<input type="hidden" name="_token" value="{{csrf_token()}}">
					<div class="form-group">
						<label for="Ten" id="lab_ten" class="control-label col-xs-2">Họ tên:</label>
						<div class="col-xs-10">
							<input type="text" id="Ten" name="Ten" value="" placeholder="Nhập họ tên" class="form-control" autocomplete="off">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="GioiTinh" id="GioiTinh" class="control-label col-xs-2">Giới tính:</label>
						<div class="col-xs-10">
					...
					<div class="form-group">
						...
						<div class="col-xs-10">
							<input type="date" id="NgaySinh" name="NgaySinh" value="" placeholder="Nhập ngày sinh" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label for="NgayVaoLam" id="lab_ngayvl" class="control-label col-xs-2">Ngày vào làm:</label>
						<div class="col-xs-10">
							<input type="date" id="NgayVaoLam" name="NgayVaoLam" value="" placeholder="Nhập ngày vào làm" class="form-control">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-xs-10">
							<input type="text" id="SoDienThoai" name="SoDienThoai" value="" placeholder="Nhập số điện thoại" class="form-control">
						</div>
					</div>
					<div class="form-group">
